...
export const QUADRANT_DESCRIPTIONS = {
  "Alto-Alto": "Colaborador que supera consistentemente las expectativas, muestra impacto y potencial de crecimiento. Se recomienda diseñar acciones para asegurar su continuo crecimiento y desarrollo.",
  ...
  "Alto-Bajo": "Colaborador que muestra potencial de desarrollo pero da un mal desempeño. Se recomienda entrenarlo y desarrollar sus capacidades, necesita claridad, foco y apoyo del líder.",
  "Medio-Alto": "Colaborador con muy buen desempeño y resultados consistentes, con posibilidad de seguir creciendo, aunque su proyección a roles más complejos es moderada.",
  ...
  "Bajo-Medio": "Colaborador que cumple satisfactoriamente con sus tareas pero no muestra cualidades para ocupar una posición de mayor responsabilidad.",
  "Bajo-Bajo": "Colaborador que muestra muy poco potencial de mejora y un mal desempeño, requiere seguimiento permanente, acciones contundentes o reconsiderar su rol.",
} as const;
